...
class ServerForm(FlaskForm):
    ...
    name = StringField('Server Name', [DataRequired(), validators.Regexp('^[a-zA-Z0-9-]{1,50}$', message='Server name cannot exceed 50 characters and can only contain letters, numbers and hyphens with no spaces i.e: ab-1234')])
